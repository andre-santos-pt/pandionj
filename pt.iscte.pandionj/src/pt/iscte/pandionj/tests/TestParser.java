...
public class TestParser {
	...
	class ForExpressionVisitor extends ASTVisitor{
		...
		private void decodeExpression(String varName, boolean iteratorOnTheLet, InfixExpression expression) {
			...
			case "==":
				...
				break;
			default:
				throw new IllegalStateException("N�o foi possivel descodificar a condi��o para terminar o for.");
			}
			...
			for(Object node : parentNode.updaters()) {
				...
				result += ", o iterador " + iterador + " " + sentido + " por " + quantidade + " a cada itera��o.";
			}
	...
	void test1() {
		...
		// ciclo for que n�o itera sobre uma array
		for(int j = 0; j < 10; j++) {
			int b = j + j;
			b = b > j ? b : j;
		}
